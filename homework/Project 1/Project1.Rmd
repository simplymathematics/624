...
arima2 <- auto.arima(atm2);
pred2  <- forecast(atm2, model = arima2, h =31 );
...
The ARIMA is clearly not a good fit for the data. So, of the remaining models, I suggest the ses because it has the smallest RMSE. 
```{r, echo = FALSE}
accuracy(model1)
accuracy(model2)
accuracy(model3)
